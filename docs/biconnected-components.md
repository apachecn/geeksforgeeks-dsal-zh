...
一个[双连通分量](https://en.wikipedia.org/wiki/Biconnected_component)是一个极大的[双连通](https://en.wikipedia.org/wiki/Biconnected_graph)T4 子图。
[双连通图](https://en.wikipedia.org/wiki/Biconnected_graph)已经在[这里](https://www.geeksforgeeks.org/biconnectivity-in-a-graph/)讨论过了。在本文中，我们将看到如何使用约翰·霍普克罗夫特和罗伯特·塔扬的算法在图中找到[双连接组件](https://en.wikipedia.org/wiki/Biconnected_component)。
...
算法基于[强连接组件](https://www.geeksforgeeks.org/tarjan-algorithm-find-strongly-connected-components/)文章中讨论的圆盘和低值。
想法是将访问过的边存储在堆栈中，而 DFS 在图形上，并继续寻找[连接点](https://www.geeksforgeeks.org/articulation-points-or-cut-vertices-in-a-graph/)(上图中突出显示)。一旦找到一个[铰接点](https://www.geeksforgeeks.org/articulation-points-or-cut-vertices-in-a-graph/) u，所有访问的边，同时从节点 u 开始的 DFS 将形成一个[双连接组件](https://en.wikipedia.org/wiki/Biconnected_component)。当一个[连接组件](https://en.wikipedia.org/wiki/Connected_component_%28graph_theory%29)的 DFS 完成时，堆叠中的所有边将形成一个双连接组件。
如果图形中没有[铰接点](https://www.geeksforgeeks.org/articulation-points-or-cut-vertices-in-a-graph/)，则图形是双连接的，因此将有一个双连接的组件，即图形本身。
