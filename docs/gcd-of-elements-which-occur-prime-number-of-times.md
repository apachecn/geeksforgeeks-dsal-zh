...
> 原文:[https://www . geeksforgeeks . org/gcd-of-of-elements-then-prime-number-of-times/](https://www.geeksforgeeks.org/gcd-of-elements-which-occur-prime-number-of-times/)

给定一个由 **N** 个元素组成的数组 **arr[]** ，任务是找到数组中具有素频率的元素的 [GCD](https://www.geeksforgeeks.org/basic-and-extended-euclidean-algorithms/) 。**注意****1**既不是质数也不是复合数。
**举例:**
...
*   使用上一步中计算的筛阵列计算具有主频的元素的 [gcd](https://www.geeksforgeeks.org/basic-and-extended-euclidean-algorithms/) 。
