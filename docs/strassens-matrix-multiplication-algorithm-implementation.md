...
> 原文:[https://www . geeksforgeeks . org/strassens-矩阵-乘法-算法-实现/](https://www.geeksforgeeks.org/strassens-matrix-multiplication-algorithm-implementation/)

斯特拉森矩阵乘法是一种典型的分治算法。我们在这里讨论了斯特拉森算法。然而，让我们再次了解分治法背后的含义，并实施它。

**前提:**需要[看](https://www.geeksforgeeks.org/strassens-matrix-multiplication/)这个帖子才能进一步了解。
