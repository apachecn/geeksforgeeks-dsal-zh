...
有向无环图（DAG）的**拓扑排序**是顶点的线性排序，使得对于每个有向边`uv`，顶点`u`都位于`v`之前 订购。 如果图形不是 DAG，则无法对图形进行拓扑排序。
...
```
4 5 0 2 3 1 4 5 2 0 3 1 4 5 2 3 0 1 4 5 2 3 1 0 5 2 3 4 0 1 5 2  3 4 1 0 5 2 4 0 3 1 5 2 4 3 0 1 5 2 4 3 1 0 5 4 0 2 3 1 5 4 2 0 3 1 5 4 2 3 0 1 5 4 2 3 1 0
```
