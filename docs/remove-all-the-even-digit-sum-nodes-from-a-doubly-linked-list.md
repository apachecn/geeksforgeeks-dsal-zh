...
给定一个包含`N`个节点的[双链表](https://www.geeksforgeeks.org/doubly-linked-list/)，任务是从列表中删除所有节点，这些节点包含数字和为偶数的元素。
...
一种简单的方法是依次遍历双链表的节点，并首先为每个节点遍历每个数字，找到该节点中存在的值的数字总和，然后最后[删除数字和为偶数的节点](https://www.geeksforgeeks.org/delete-a-node-in-a-doubly-linked-list/)。
