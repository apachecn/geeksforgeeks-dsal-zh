# Python3 搜索排序旋转数组中元素的程序

> 原文:[https://www . geeksforgeeks . org/python 3-搜索排序旋转数组中的元素的程序/](https://www.geeksforgeeks.org/python3-program-for-search-an-element-in-a-sorted-and-rotated-array/)
