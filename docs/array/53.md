...
给定 n 个整数的数组，请找到 3 个元素，以便在 0（n）时间内 a [i] < a [j] < a [k]和 i < j < k。 如果有多个这样的三胞胎，请打印其中的任何一个。
...
## [推荐：请先在“ ***<u>实践</u>*** ”上解决它，然后再继续解决。](https://practice.geeksforgeeks.org/problems/sorted-subsequence-of-size-3/1)
