# 未排序数组中第 K 个最小/最大元素| 设置 2（预期线性时间）
...
[未排序数组中第 K 个最小/最大元素| 设置 1](https://www.geeksforgeeks.org/kth-smallestlargest-element-unsorted-array/)
...
我们在此处讨论了三种不同的解决方案[。](https://www.geeksforgeeks.org/kth-smallestlargest-element-unsorted-array/)

本文讨论了方法 4，它主要是对[先前](https://www.geeksforgeeks.org/kth-smallestlargest-element-unsorted-array/)帖子中讨论的方法 3（QuickSelect）的扩展。
