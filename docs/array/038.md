...
**来源**： [Microsoft IDC 面试体验| 系列 150](https://www.geeksforgeeks.org/microsoft-idc-interview-experience-set-150-full-time/)

> [推荐：请先解决 ***惯例*** ，然后再继续解决。](https://practice.geeksforgeeks.org/problems/ease-the-array/0)
