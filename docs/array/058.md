...
如果您尚未阅读我的上一篇文章，请在[此处阅读](https://www.geeksforgeeks.org/longest-monotonically-increasing-subsequence-size-n-log-n/)。 请注意，以下代码以相反的顺序打印 LIS。 我们可以使用堆栈（显式堆栈或系统堆栈）修改打印顺序。 我将解释作为练习（简单）进行。
