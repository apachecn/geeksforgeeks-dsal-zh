...
我们已经讨论了[打印`k`个最大元素](https://www.geeksforgeeks.org/k-largestor-smallest-elements-in-an-array/)的类似的问题。
...
有两种以上的解决方案比上面讨论的解决方案更好：一种解决方案是对[`quickSelect()`](https://www.geeksforgeeks.org/quickselect-algorithm/)进行随机化处理，另一种解决方案是最坏情况的线性时间算法（请参阅以下文章）。
