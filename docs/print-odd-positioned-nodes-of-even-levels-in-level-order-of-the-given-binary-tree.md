# 按照给定二叉树的级别顺序打印偶数级别的奇数位置节点

> 原文:[https://www . geeksforgeeks . org/print-奇数位偶数级节点-给定二叉树的级序/](https://www.geeksforgeeks.org/print-odd-positioned-nodes-of-even-levels-in-level-order-of-the-given-binary-tree/)

给定一棵二叉树，任务是在树的级别顺序遍历中打印偶数级别的奇数位置节点。根被认为是级别 **0** ，任何级别的最左边的节点被认为是位置 **0** 的节点。
**例:**
