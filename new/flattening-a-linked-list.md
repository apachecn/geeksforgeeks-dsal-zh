...
1.  指向主列表中下一个节点的指针（在下面的代码中我们称之为“向右”指针）
...
这个想法是对链表使用[归并排序的`Merge()`过程](https://www.geeksforgeeks.org/merge-sort-for-linked-list/)。我们使用`merge()`逐一合并列表。 我们以递归方式将当前列表与已经变平的列表合并。
