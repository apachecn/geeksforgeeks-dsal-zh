...
给定**定向** [**图**](https://www.geeksforgeeks.org/graph-data-structure-and-algorithms/) 的`N`顶点和`M`边，任务是找到最小的 制作给定图形 [**强连接的**](https://www.geeksforgeeks.org/strongly-connected-components/) 所需的边。
