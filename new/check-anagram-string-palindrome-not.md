...
此问题基本上与[“检查给定字符串的字符是否可以重新排列以生成回文”](https://www.geeksforgeeks.org/check-characters-given-string-can-rearranged-form-palindrome/)相同。 我们可以使用`count`数组在`O(n)`时间内完成此操作。 以下是详细步骤。
