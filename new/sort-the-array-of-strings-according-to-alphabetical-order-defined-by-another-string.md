...
> **输入**：`str = "fguecbdavwyxzhijklmnopqrst", strArr[] = {"geeksforgeeks", "is", "the", "best", "place", "for", "learning"}`
>
> **输出**：`for geeksforgeeks best is learning place the`
> 
> **输入**：`str = "avdfghiwyxzjkecbmnopqrstul", strArr[] = {"rainbow", "consists", "of", "colours"}`
>
> **输出**：`consists colours of rainbow`

**方法**：遍历`str`的每个字符，并将值存储在以**字符**作为**键**及其**数组中的索引**作为**值**。
