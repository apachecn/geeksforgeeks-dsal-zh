...
**朴素的方法**：想法是[生成所有可能的对](https://www.geeksforgeeks.org/find-all-pairs-possible-from-the-given-array/)并检查其[总和是否设置了所有位](https://www.geeksforgeeks.org/check-bits-number-set/)。 如果发现是真的，则在结果计数中计算该对。 检查所有对后，打印计数。
