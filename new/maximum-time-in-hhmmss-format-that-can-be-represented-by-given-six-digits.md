...
**注意**：24 小时格式的最短时间为`00:00:00`，最大时间为`23:59:59`。 如果无法生成有效时间，请打印 -1。
...
> **说明**：
>
> 使用数组数字可以生成的最大 24 小时格式化时间是`23:29:10`。
> 
> **输入**：`arr[] = {6, 2, 6, 7, 5, 6}`
>
> **输出**：-1
...
*   创建[哈希映射](https://www.geeksforgeeks.org/hashing-data-structure/)并将数字的频率存储在给定数组中。

*   从最大时间`23:59:59`迭代到最小时间`00:00:00`。

*   对于每次，请检查是否所有数字都在哈希映射中。
