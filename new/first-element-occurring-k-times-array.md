...
给定`n`个整数数组。 任务是找到出现`k`次的第一个元素。 如果没有元素出现`k`次，则打印 -1。 整数元素的分布可以在任何范围内。

**示例**：

> **输入**：`{1, 7, 4, 3, 4, 8, 7}, k = 2`
>
> **输出**：7
>
> **7** 和 **4** 都出现 2 次。
...
**高效方法**：将[`unordered_map`](https://www.geeksforgeeks.org/unordered_map-in-stl-and-its-applications/)用于散列，因为范围未知。 
