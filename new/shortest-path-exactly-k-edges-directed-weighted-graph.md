...
> 原文： [https://www.geeksforgeeks.org/shortest-path-exactly-k-edges-directed-weighted-graph/](https://www.geeksforgeeks.org/shortest-path-exactly-k-edges-directed-weighted-graph/)

给定其中一个有向顶点和两个顶点“ u”和“ v”，找到从“ u”到“ v”的最短路径，路径上恰好有 k 条边。
...
上述基于 DP 的解决方案的时间复杂度为 O（V <sup>3</sup> K），这比朴素的解决方案好得多。
