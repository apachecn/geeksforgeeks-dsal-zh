...
**简单实现**
下面的程序创建一个简单的展开的链表，其中包含3个节点，每个节点中包含可变数量的元素。 它还遍历创建的列表。
...
在本文中，我们介绍了展开列表及其优点。 我们还展示了如何遍历列表。 在下一篇文章中，我们将详细讨论maxElements / numElements的插入，删除和值。
