...
**方法**：我们在[此处](https://www.geeksforgeeks.org/sum-of-two-linked-lists/)讨论了一种解决方案，在该解决方案中，我们使用递归达到列表中的最小有效数字，但是由于栈的参与，解决方案的空间复杂性 变成`O(n)`

这里的目标是原地求和，并返回修改后的和列表。

我们的想法是首先反转两个链表，因此链表的新头部指向最低有效数字，我们可以按[此处](https://www.geeksforgeeks.org/?p=15194/)的说明开始添加，而不是创建新列表，而是修改现有的列表 并返回修改后列表的头。
