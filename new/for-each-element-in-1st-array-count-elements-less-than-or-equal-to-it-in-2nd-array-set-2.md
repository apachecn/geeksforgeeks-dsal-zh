...
> **输出**：`[4, 5, 5, 6, 6, 6]`
>
> **说明**：第二个数组中有 4 个小于或等于 1 的元素，类似地，有 5 个元素小于第二个数组中的 2，对其他元素也类似地计算值。
> 
> **输入**：`arr1 [] = [5, 10, 2, 6, 1, 8, 6, 12], arr2 [] = [6, 5, 11, 4, 2, 3, 7 ]`
>
> **输出**：`[4, 6, 1, 5, 0, 6, 5, 7]`
>
> **说明**：第二个数组中有 4 个小于或等于 5 的元素，类似地，有 6 个元素小于第二个数组中的 10，对其他元素也类似地计算值。
...
**替代方法**：该方法仅将数组替换为向量，并且将使用数组生成的哈希映射替换为映射。 方法和算法保持不变。
