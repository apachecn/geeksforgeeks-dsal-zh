...
**b）**列表 10- > 20- > 30- > 40- > 50- > 60- > NULL 应该更改为 60- > 空值。 请注意，已删除 10、20、30、40 和 50，因为它们在右侧都具有较大的值。

**c）**列表 60- > 50- > 40- > 30- > 20- > 10- > NULL 不应更改。

**方法**：我们已经通过使用 2 个循环并反转帖子中的链表来解决此问题[删除右侧具有较大值的节点](https://www.geeksforgeeks.org/delete-nodes-which-have-a-greater-value-on-right-side/)
