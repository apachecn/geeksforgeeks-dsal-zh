...
> **说明**：
>
> 一种可能的排列是`{1, 2, 2, 2, 3, 4, 5}`，其最大和为 19。

**朴素的方法**：最简单的方法是[对给定的数组排序](https://www.geeksforgeeks.org/c-program-to-sort-an-array-in-ascending-order/)，然后遍历已排序的数组并减少不满足给定条件的元素。
